...
Check local checkouts of BalanceHQ repositories  (located at `~/code/balancehq` - all directories here are valid targets) for work done today, then update your BalanceHQ Obsidian vault (stored at `~/obsidian/balanceHQ/`).
